---
title: "The association between the consumption of legumes and incidence of type 2 diabetes: the EPIC-Norfolk study"
output:
...
cox_G <- coxph(dff.surv~legume_rankea+legumesvge+LCMedianea)
summary(cox_G)
...
cox_M1 <- coxph(Surv(entryage, exitage, DM_INC08)~legume_rankea+LCMedianea+legumesvge+LCMedianea+
                  SEX)
summary(cox_M1)
...
cox_M2 <- coxph(Surv(entryage, exitage, DM_INC08)~legume_rankea+legumesvge+LCMedianea+
                  SEX+
...
cox_M3 <- coxph(Surv(entryage, exitage, DM_INC08)~legume_rankea+legumesvge+LCMedianea+
                  SEX+
                  CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                  D1_VEG_A+D1_FRUIT_A++Fish+Meat+MILK+EGGS+D1_NUT065+
...
cox_M4 <- coxph(Surv(entryage, exitage, DM_INC08)~legume_rankea+legumesvge+LCMedianea+
                  SEX+
                  CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                  D1_VEG_A+D1_FRUIT_A++Fish+Meat+MILK+EGGS+D1_NUT065+
                  FH_DM+FH_CVA+strata(FH_MI)+FH_CA+
...
phtest2 <-cox.zph(cox_M4)
phtest2

ggcoxzph(phtest2)


## Interaction between quartiles of legume consumption age, Sex, BMI, Waist

#Interaction with Age
cox_M5 <- coxph(Surv(entryage, exitage, DM_INC08)~legume_rankea*AGE+legumesvge+LCMedianea+
                  SEX+
                  CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                  D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065+
                  FH_DM+FH_CVA+strata(FH_MI)+FH_CA+
...
SEX <- factor(dff$SEX, levels=c(1,2))
cox_M6 <- coxph(Surv(entryage, exitage, DM_INC08)~legume_rankea*SEX+legumesvge+LCMedianea+
                  CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                  D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065+
                  FH_DM+FH_CVA+strata(FH_MI)+FH_CA+
                  BMI+WAIST_Class)
...
cox_M7 <- coxph(Surv(entryage, exitage, DM_INC08)~legume_rankea*BMI+legumesvge+LCMedianea+
                  SEX+
                  CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                  D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065+
                  FH_DM+FH_CVA+strata(FH_MI)+FH_CA+
...
cox_M8 <- coxph(Surv(entryage, exitage, DM_INC08)~legume_rankea*WAIST_Class+legumesvge+LCMedianea+
                  SEX+
                  CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                  D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065+
                  FH_DM+FH_CVA+strata(FH_MI)+FH_CA+
...
#Likelihood ratio test for Quartiles of legume and Age

library(lmtest)

lrtest(cox_M4, cox_M5)

#Likelihood ratio test for Quartiles of legume and Sex
lrtest(cox_M4, cox_M6)

#Likelihood ratio test for Quartiles of legume and BMI
lrtest(cox_M4, cox_M7)

#Likelihood ratio test for Quartiles of legume and Waist
...
```{r}
mfit1 <- coxph(Surv(entryage, exitage, DM_INC08)~legume_rankea+pspline(legumesvge,4)+LCMedianea+
                  SEX+
                  CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                  D1_VEG_A+D1_FRUIT_A++Fish+Meat+MILK+EGGS+D1_NUT065+
                  FH_DM+FH_CVA+FH_CA+
                  BMI+WAIST_Class, data=dff)

summary(mfit1)



termplot(mfit1, terms = 2, se=TRUE, col.term = 1, col.se = 1, xlabs = "Serving of Total Legume/day", ylabs = "log HR", ylim = c(-5,5))
...
cox_GL <- coxph(dff.surv~lentil_rankea+lentilsvge+lentilMedianea)
summary(cox_GL)
...
cox_ML1 <- coxph(Surv(entryage, exitage, DM_INC08)~lentil_rankea+lentilsvge+lentilMedianea+
                  SEX)
summary(cox_ML1)
...
cox_ML2 <- coxph(Surv(entryage, exitage, DM_INC08)~lentil_rankea+lentilsvge+lentilMedianea+
                  SEX+
                  CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                  D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065)
summary(cox_ML2)
...
cox_ML3 <- coxph(Surv(entryage, exitage, DM_INC08)~lentil_rankea+lentilsvge+lentilMedianea+
                  SEX+
                  CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                  D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065+
                  FH_DM+FH_CVA+strata(FH_MI)+FH_CA)
...
# Model 4: Additionally Adjusted for Anthropometric Covariates
WAIST_Class <- factor(dff$WAIST_Class, levels=c(1,2))
cox_ML4 <- coxph(Surv(entryage, exitage, DM_INC08)~lentil_rankea+lentilsvge+lentilMedianea+
                  SEX+
                  CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                  D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065+
                  FH_DM+FH_CVA+strata(FH_MI)+FH_CA+
...
phtestL2 <-cox.zph(cox_ML4)
phtestL2
ggcoxzph(phtestL2)

## Interaction between quartiles of lentil consumption Age, Sex and BMI
#Interaction with Age
cox_ML5 <- coxph(Surv(entryage, exitage, DM_INC08)~lentil_rankea*AGE+lentilsvge+lentilMedianea+
                   SEX+
                   CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                   D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065+
                   FH_DM+FH_CVA+strata(FH_MI)+FH_CA+
...
#Interaction with Sex
SEX <- factor(dff$SEX, levels=c(1,2))
cox_ML6 <- coxph(Surv(entryage, exitage, DM_INC08)~lentil_rankea*SEX+lentilsvge+lentilMedianea+
                   CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                   D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065+
                   FH_DM+FH_CVA+strata(FH_MI)+FH_CA+
                   BMI+WAIST_Class)
...
#Interaction with BMI
cox_ML7 <- coxph(Surv(entryage, exitage, DM_INC08)~lentil_rankea*BMI+lentilsvge+lentilMedianea+
                   SEX+
                   CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                   D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065+
                   FH_DM+FH_CVA+strata(FH_MI)+FH_CA+
...
#Interaction with Waist
cox_ML8 <- coxph(Surv(entryage, exitage, DM_INC08)~lentil_rankea*WAIST_Class+lentilsvge+lentilMedianea+
                   SEX+
                   CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                   D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065+
                   FH_DM+FH_CVA+strata(FH_MI)+FH_CA+
...
#Likelihood ratio test for Quartiles of lentil and Age)
lrtest(cox_ML4, cox_ML5)

#Likelihood ratio test for Quartiles of lentil and Sex)
lrtest(cox_ML4, cox_ML6)

#Likelihood ratio test for Quartiles of lentil and BMI
lrtest(cox_ML4, cox_ML7)

#Likelihood ratio test for Quartiles of lentil and Waist
...
```{r}
mfit2 <- coxph(Surv(entryage, exitage, DM_INC08)~lentil_rankea+pspline(lentilsvge,4)+lentilMedianea+
                  SEX+
                  CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                  D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065+
                  FH_DM+FH_CVA+strata(FH_MI)+FH_CA+
...
termplot(mfit2, terms = 2, se=TRUE, col.term = 1, col.se = 1, xlabs = "Serving of lentils/day", ylabs = "log HR", ylim = c(-5,5))
```
...
cox_GP <- coxph(dff.surv~peas_rankea+peasvge+PeasMedianea)
summary(cox_GP)
...
cox_MP1 <- coxph(Surv(entryage, exitage, DM_INC08)~peas_rankea+peasvge+PeasMedianea+
                   SEX)
summary(cox_MP1)
...
cox_MP2 <- coxph(Surv(entryage, exitage, DM_INC08)~peas_rankea+peasvge+PeasMedianea+
                   SEX+
                   CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                   D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065)
summary(cox_MP2)
...
cox_MP3 <- coxph(Surv(entryage, exitage, DM_INC08)~peas_rankea+peasvge+PeasMedianea+
                   SEX+
                   CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                   D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065+
                   FH_DM+FH_CVA+strata(FH_MI)+FH_CA)
...
# Model 4: Additionally Adjusted for Anthropometric Covariates
WAIST_Class <- factor(dff$WAIST_Class, levels=c(1,2))
cox_MP4 <- coxph(Surv(entryage, exitage, DM_INC08)~peas_rankea+peasvge+PeasMedianea+
                   SEX+
                   CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                   D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065+
                   FH_DM+FH_CVA+strata(FH_MI)+FH_CA+
...
phtestP2 <-cox.zph(cox_MP4)
phtestP2
ggcoxzph(phtestP2)


## Interaction between quartiles of peas consumption Age, Sex and BMI
#Interaction with Age
cox_MP5 <- coxph(Surv(entryage, exitage, DM_INC08)~peas_rankea*AGE++peasvge+PeasMedianea+
                   SEX+
                   CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                   D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065+
                   FH_DM+FH_CVA+strata(FH_MI)+FH_CA+
...
#Interaction with Sex
SEX <- factor(dff$SEX, levels=c(1,2))
cox_MP6 <- coxph(Surv(entryage, exitage, DM_INC08)~peas_rankea*SEX++peasvge+PeasMedianea+
                   CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                   D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065+
                   FH_DM+FH_CVA+strata(FH_MI)+FH_CA+
                   BMI+WAIST_Class)
...
#Interaction with BMI
cox_MP7 <- coxph(Surv(entryage, exitage, DM_INC08)~peas_rankea*BMI++peasvge+PeasMedianea+
                   SEX+
                   CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                   D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065+
                   FH_DM+FH_CVA+strata(FH_MI)+FH_CA+
...
#Interaction with Waist
cox_MP8 <- coxph(Surv(entryage, exitage, DM_INC08)~peas_rankea*WAIST_Class++peasvge+PeasMedianea+
                   SEX+
                   CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                   D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065+
                   FH_DM+FH_CVA+strata(FH_MI)+FH_CA+
...
#Likelihood ratio test for Quartiles of Peas and Age)
lrtest(cox_MP4, cox_MP5)

#Likelihood ratio test for Quartiles of Peas and Sex)
lrtest(cox_MP4, cox_MP6)

#Likelihood ratio test for Quartiles of Peas and BMI
lrtest(cox_MP4, cox_MP7)

#Likelihood ratio test for Quartiles of Peas and Waist
...
```{r}
mfit3 <- coxph(Surv(entryage, exitage, DM_INC08)~peas_rankea+pspline(peasvge, 4)+PeasMedianea+
                   SEX+
                   CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                   D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065+
                   FH_DM+FH_CVA+strata(FH_MI)+FH_CA+
...
termplot(mfit3, terms = 2, se=TRUE, col.term = 1, col.se = 1, xlabs = "Serving of Peas/day", ylabs = "log HR", ylim = c(-5,5))
```
...
cox_GB <- coxph(dff.surv~beans_rankea+beansvge+BeansMedianea)
summary(cox_GB)
...
cox_MB1 <- coxph(Surv(entryage, exitage, DM_INC08)~beans_rankea+beansvge+BeansMedianea+
                   SEX)
summary(cox_MB1)
...
cox_MB2 <- coxph(Surv(entryage, exitage, DM_INC08)~beans_rankea+beansvge+BeansMedianea+
                   SEX+
                   CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                   D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065)
summary(cox_MB2)
...
cox_MB3 <- coxph(Surv(entryage, exitage, DM_INC08)~beans_rankea+beansvge+BeansMedianea+
                   SEX+
                   CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                   D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065+
                   FH_DM+FH_CVA+strata(FH_MI)+FH_CA)
...
# Model 4: Additionally Adjusted for Anthropometric Covariates
WAIST_Class <- factor(dff$WAIST_Class, levels=c(1,2))
cox_MB4 <- coxph(Surv(entryage, exitage, DM_INC08)~beans_rankea+beansvge+BeansMedianea+
                   SEX+
                   CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                   D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065+
                   FH_DM+FH_CVA+strata(FH_MI)+FH_CA+
...
## Interaction between quartiles of bean consumption Age, Sex and BMI

#Interaction with Age
cox_MB5 <- coxph(Surv(entryage, exitage, DM_INC08)~beans_rankea*AGE+beansvge+BeansMedianea+
                   SEX+
                   CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                   D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065+
                   FH_DM+FH_CVA+strata(FH_MI)+FH_CA+
...
#Interaction with Sex
SEX <- factor(dff$SEX, levels=c(1,2))
cox_MB6 <- coxph(Surv(entryage, exitage, DM_INC08)~beans_rankea*SEX+beansvge+BeansMedianea+
                   CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                   D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065+
                   FH_DM+FH_CVA+strata(FH_MI)+FH_CA+
                   BMI+WAIST_Class)
...
#Interaction with BMI
cox_MB7 <- coxph(Surv(entryage, exitage, DM_INC08)~beans_rankea*BMI+beansvge+BeansMedianea+
                   SEX+
                   CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                   D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065+
                   FH_DM+FH_CVA+strata(FH_MI)+FH_CA+
...
#Interaction with Waist
cox_MB8 <- coxph(Surv(entryage, exitage, DM_INC08)~beans_rankea*WAIST_Class+beansvge+BeansMedianea+
                   SEX+
                   CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                   D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065+
                   FH_DM+FH_CVA+strata(FH_MI)+FH_CA+
...
#Likelihood ratio test for Quartiles of beans and Age)
lrtest(cox_MB4, cox_MB5)

#Likelihood ratio test for Quartiles of beans and Sex)
lrtest(cox_MB4, cox_MB6)

#Likelihood ratio test for Quartiles of beans and BMI
lrtest(cox_MB4, cox_MB7)

#Likelihood ratio test for Quartiles of beans and Waist
...
```{r}
mfit4 <- coxph(Surv(entryage, exitage, DM_INC08)~beans_rankea+pspline(beansvge, 4)+BeansMedianea+
                   SEX+
                   CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                   D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065+
                   FH_DM+FH_CVA+strata(FH_MI)+FH_CA+
...
termplot(mfit4, terms = 2, se=TRUE, col.term = 1, col.se = 1, xlabs = "Serving of Beans/day", ylabs = "log HR", ylim = c(-5,5))
```
...
cox_SM1 <- coxph(Surv(entryage, exitage, DM_INC08)~legume_rankea+LCMedianea+
                   SEX+
                   CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                   D1_VEG_A+D1_FRUIT_A+D1_WFISH_A+D1_FFISH_A+D1_RMEAT_A+
                   D1_WMEAT_A+D1_PRMEAT_A+MILK+EGGS+D1_NUT064+LENTILQUANT_SUM+
...
LHR1 <- (20*cox_SM1$coefficients[28])-(50*cox_SM1$coefficients[22])
LHR1

HR1 =exp(LHR1)
HR1

var1=(20^2)*cox_SM1$var[28,28]+(50^2)*cox_SM1$var[22,22]-(2*20*50*cox_SM1$var[22,28])
...
LHR2 <- (20*cox_SM1$coefficients[28])-(50*cox_SM1$coefficients[23])
LHR2

HR2 =exp(LHR2)
HR2

var2=(20^2)*cox_SM1$var[28,28]+(50^2)*cox_SM1$var[23,23]-(2*20*50*cox_SM1$var[28,23])
...
LHR3 <- (20*cox_SM1$coefficients[28])-(50*cox_SM1$coefficients[24])
LHR3

HR3 =exp(LHR3)
HR3

var3=(20^2)*cox_SM1$var[28,28]+(50^2)*cox_SM1$var[24,24]-(2*20*50*cox_SM1$var[28,24])
...
LHR4 <- (20*cox_SM1$coefficients[28])-(50*cox_SM1$coefficients[20])
LHR4

HR4 =exp(LHR4)
HR4

var4=(20^2)*cox_SM1$var[28,28]+(50^2)*cox_SM1$var[20,20]-(2*20*50*cox_SM1$var[28,20])
...
LHR5 <- (20*cox_SM1$coefficients[28])-(50*cox_SM1$coefficients[21])
LHR5

HR5 =exp(LHR5)
HR5

var5=(20^2)*cox_SM1$var[28,28]+(50^2)*cox_SM1$var[21,21]-(2*20*50*cox_SM1$var[28,21])
...
LHR6 <- (20*cox_SM1$coefficients[28])-(50*cox_SM1$coefficients[26])
LHR6

HR6 =exp(LHR6)
HR6

var6=(20^2)*cox_SM1$var[28,28]+(50^2)*cox_SM1$var[26,26]-(2*20*50*cox_SM1$var[28,26])
...
LHR8 <- (20*cox_SM1$coefficients[28])-(200*cox_SM1$coefficients[25])
LHR8

HR8 =exp(LHR8)
HR8

var8=(20^2)*cox_SM1$var[28,28]+(200^2)*cox_SM1$var[25,25]-(2*20*200*cox_SM1$var[28,25])
...
# 1.06 (0.88-1.27), p=0.55

```

## substituting legume (50g/day) for Yogurt (70g/day)
...
LHR9 <- (20*cox_SM1$coefficients[28])-(70*cox_SM1$coefficients[29])
LHR9

HR9 =exp(LHR9)
HR9

var9=(20^2)*cox_SM1$var[28,28]+(70^2)*cox_SM1$var[29,29]-(2*20*70*cox_SM1$var[28,29])
...
LHR10 <- (20*cox_SM1$coefficients[28])-(30*cox_SM1$coefficients[30])
LHR10

HR10 =exp(LHR10)
HR10

var10=(20^2)*cox_SM1$var[28,28]+(30^2)*cox_SM1$var[30,30]-(2*20*30*cox_SM1$var[28,30])
...
LHR11 <- (20*cox_SM1$coefficients[28])-(30*cox_SM1$coefficients[31])
LHR11

HR11 =exp(LHR11)
HR11

var11=(20^2)*cox_SM1$var[28,28]+(30^2)*cox_SM1$var[31,31]-(2*20*30*cox_SM1$var[28,31])
...
LHR12 <- (20*cox_SM1$coefficients[28])-(10*cox_SM1$coefficients[32])
LHR12

HR12 =exp(LHR12)
HR12

var12=(20^2)*cox_SM1$var[28,28]+(10^2)*cox_SM1$var[32,32]-(2*20*10*cox_SM1$var[28,32])
...
data <- structure(list(mean  = c(NA, NA, 0.90, 0.97, 0.96, 1.01, 0.89, 0.95, 1.06, 1.16, 1.08, 1.02, 0.99), 
                                      lower = c(NA, NA, 0.75, 0.81, 0.78, 0.81, 0.73, 0.73, 0.88, 0.96, 0.89, 0.88, 0.83),
                                      upper = c(NA, NA, 1.08, 1.17, 1.21, 1.27, 1.09, 1.25, 1.27, 1.41, 1.31, 1.19, 1.18)),
...
text <- cbind(c("", "Food", "Red Meat", "White Meat", "Processed Meat", "White Fish",
              ...
              c("", "Serving size", '50g', '50g', '50g', '50g', '50g', '50g', "200g",
                "70g", "30g", "30g", "10g"),
                   c("", "HRs (95% CI)", '0.90 (0.75,1.08)', '0.97 (0.81,1.17)', 
                     '0.96 (0.78,1.21)', '1.01 (0.81,1.27)', '0.89 (0.73,1.09)', '0.95 (0.73,1.25)',
                     '1.06 (0.88,1.27)','1.16 (0.96,1.41)','1.08 (0.89,1.31)','1.02 (0.88,1.19)',
                     '0.99 (0.83,1.18)'))
...
#Univariate Model
################################################################################
#Legume consumption (Non-consumer and Tertiles of Consumer(0,1,2,3))
legume_rankeap <- factor(dff$legume_rankeap, levels=c(0,1,2,3))

cox_GP <- coxph(dff.surv~legume_rankeap+legumepsvg+LCMedianeap)
summary(cox_GP)
...
cox_M1P <- coxph(Surv(entryage, exitage, DM_INC08)~legume_rankeap+legumepsvg+LCMedianeap+
                   SEX)
summary(cox_M1P)
...
cox_M2P <- coxph(Surv(entryage, exitage, DM_INC08)~legume_rankeap+legumepsvg+LCMedianeap+
                   SEX+
                   CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                   D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065)
summary(cox_M2P)
...
cox_M3P <- coxph(Surv(entryage, exitage, DM_INC08)~legume_rankeap+legumepsvg+LCMedianeap+
                   SEX+
                   CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                   D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065+
                   FH_DM+FH_CVA+strata(FH_MI)+FH_CA)
...
# Model 4: Additionally Adjusted for Anthropometric Covariates
WAIST_Class <- factor(dff$WAIST_Class, levels=c(1,2))
cox_M4P <- coxph(Surv(entryage, exitage, DM_INC08)~legume_rankeap+legumepsvg+LCMedianeap+
                   SEX+
                   CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                   D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065+
                   FH_DM+FH_CVA+strata(FH_MI)+FH_CA+
...
cox_GV <- coxph(dff.surv~DC_rank+DCsvg+DCLCMedian)
summary(cox_GV)
...
cox_M1V <- coxph(Surv(entryage, exitage, DM_INC08)~DC_rank+DCsvg+DCLCMedian+
                   SEX)
summary(cox_M1V)
...
cox_M2V <- coxph(Surv(entryage, exitage, DM_INC08)~DC_rank+DCsvg+DCLCMedian+
                   SEX+
                   CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                   D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065)
summary(cox_M2V)
...
cox_M3V <- coxph(Surv(entryage, exitage, DM_INC08)~DC_rank+DCsvg+DCLCMedian+
                   SEX+
                   CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                   D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065+
                   FH_DM+FH_CVA+strata(FH_MI)+FH_CA)
...
# Model 4: Additionally Adjusted for Anthropometric Covariates
WAIST_Class <- factor(dff$WAIST_Class, levels=c(1,2))
cox_M4V <- coxph(Surv(entryage, exitage, DM_INC08)~DC_rank+DCsvg+DCLCMedian+
                   SEX+
                   CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                   D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065+
                   FH_DM+FH_CVA+strata(FH_MI)+FH_CA+
...
cox_GV <- coxph(dff.surv~DCanned_rank+Cannedsvg+CLCMedian)
summary(cox_GV)
...
cox_M1V <- coxph(Surv(entryage, exitage, DM_INC08)~DCanned_rank+Cannedsvg+CLCMedian+
                   SEX)
summary(cox_M1V)
...
cox_M2V <- coxph(Surv(entryage, exitage, DM_INC08)~DCanned_rank+Cannedsvg+CLCMedian+
                   SEX+
                   CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                   D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065)
summary(cox_M2V)
...
cox_M3V <- coxph(Surv(entryage, exitage, DM_INC08)~DCanned_rank+Cannedsvg+CLCMedian+
                   SEX+
                   CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                   D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065+
                   FH_DM+FH_CVA+strata(FH_MI)+FH_CA)
...
# Model 4: Additionally Adjusted for Anthropometric Covariates
WAIST_Class <- factor(dff$WAIST_Class, levels=c(1,2))
cox_M4V <- coxph(Surv(entryage, exitage, DM_INC08)~DCanned_rank+Cannedsvg+CLCMedian+
                   SEX+
                   CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                   D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065+
                   FH_DM+FH_CVA+strata(FH_MI)+FH_CA+
...
cox_GV <- coxph(dff.surv~vdish_rank+Vegsvg+VLCMedian)
summary(cox_GV)
...
cox_M1V <- coxph(Surv(entryage, exitage, DM_INC08)~vdish_rank+Vegsvg+VLCMedian+
                   SEX)
summary(cox_M1V)
...
cox_M2V <- coxph(Surv(entryage, exitage, DM_INC08)~vdish_rank+Vegsvg+VLCMedian+
                   SEX+
                   CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                   D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065)
summary(cox_M2V)
...
cox_M3V <- coxph(Surv(entryage, exitage, DM_INC08)~vdish_rank+Vegsvg+VLCMedian+
                   SEX+
                   CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                   D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065+
                   FH_DM+FH_CVA+strata(FH_MI)+FH_CA)
...
# Model 4: Additionally Adjusted for Anthropometric Covariates
WAIST_Class <- factor(dff$WAIST_Class, levels=c(1,2))
cox_M4V <- coxph(Surv(entryage, exitage, DM_INC08)~vdish_rank+Vegsvg+VLCMedian+
                   SEX+
                   CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                   D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065+
                   FH_DM+FH_CVA+strata(FH_MI)+FH_CA+
...
cox_GM <- coxph(dff.surv~mdish_rank+Msvg+MLCMedian)
summary(cox_GM)
...
cox_M1M <- coxph(Surv(entryage, exitage, DM_INC08)~mdish_rank+Msvg+MLCMedian+
                   SEX)
summary(cox_M1M)
...
cox_M2M <- coxph(Surv(entryage, exitage, DM_INC08)~mdish_rank+Msvg+MLCMedian+
                   SEX+
                   CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                   D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065)
summary(cox_M2M)
...
cox_M3M <- coxph(Surv(entryage, exitage, DM_INC08)~mdish_rank+Msvg+MLCMedian+
                   SEX+
                   CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                   D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065+
                   FH_DM+FH_CVA+strata(FH_MI)+FH_CA)
...
# Model 4: Additionally Adjusted for Anthropometric Covariates
WAIST_Class <- factor(dff$WAIST_Class, levels=c(1,2))
cox_M4M <- coxph(Surv(entryage, exitage, DM_INC08)~mdish_rank+Msvg+MLCMedian+
                   SEX+
                   CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                   D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065+
                   FH_DM+FH_CVA+strata(FH_MI)+FH_CA+
...
cox_GF <- coxph(dff.surv~fdish_rank+Fsvg+FLCMedian)
summary(cox_GF)
...
cox_M1F <- coxph(Surv(entryage, exitage, DM_INC08)~fdish_rank+Fsvg+FLCMedian+
                   SEX)
summary(cox_M1F)
...
cox_M2F <- coxph(Surv(entryage, exitage, DM_INC08)~fdish_rank+Fsvg+FLCMedian+
                   SEX+
                   CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                   D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065)
summary(cox_M2F)
...
cox_M3F <- coxph(Surv(entryage, exitage, DM_INC08)~fdish_rank+Fsvg+FLCMedian+
                   SEX+
                   CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                   D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065+
                   FH_DM+FH_CVA+strata(FH_MI)+FH_CA)
...
# Model 4: Additionally Adjusted for Anthropometric Covariates
WAIST_Class <- factor(dff$WAIST_Class, levels=c(1,2))
cox_M4F <- coxph(Surv(entryage, exitage, DM_INC08)~fdish_rank+Fsvg+FLCMedian+
                   SEX+
                   CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                   D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065+
                   FH_DM+FH_CVA+strata(FH_MI)+FH_CA+
...
cox_GS2L <- coxph(dff.surv~legume_rankr+legumesvg+LCMedianr)
summary(cox_GS2L)
...
cox_M1S2L <- coxph(Surv(entryage, exitage, DM_INC08)~legume_rankr+legumesvg+LCMedianr+
                  SEX)
summary(cox_M1S2L)
...
cox_M2S2L <- coxph(Surv(entryage, exitage, DM_INC08)~legume_rankr+legumesvg+LCMedianr+
                  SEX+
                  CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                  D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065)
summary(cox_M2S2L)
...
cox_M3S2L <- coxph(Surv(entryage, exitage, DM_INC08)~legume_rankr+legumesvg+LCMedianr+
                  SEX+
                  CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                  D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065+
                  FH_DM+FH_CVA+strata(FH_MI)+FH_CA)
...
# Model 4: Additionally Adjusted for Anthropometric Covariates
WAIST_Class <- factor(dff$WAIST_Class, levels=c(1,2))
cox_M4S2L <- coxph(Surv(entryage, exitage, DM_INC08)~legume_rankr+legumesvg+LCMedianr+
                  SEX+
                  CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                  D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065+
                  FH_DM+FH_CVA+strata(FH_MI)+FH_CA+
...
cox_GS2l <- coxph(dff.surv~lentil_rank+lentilsvg+lentilMedian)
summary(cox_GS2l)
...
cox_M1S2l <- coxph(Surv(entryage, exitage, DM_INC08)~lentil_rank+lentilsvg+lentilMedian+
                   SEX)
summary(cox_M1S2l)
...
cox_M2S2l <- coxph(Surv(entryage, exitage, DM_INC08)~lentil_rank+lentilsvg+lentilMedian+
                   SEX+
                   CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                   D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065)
summary(cox_M2S2l)
...
cox_M3S2l <- coxph(Surv(entryage, exitage, DM_INC08)~lentil_rank+lentilsvg+lentilMedian+
                   SEX+
                   CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                   D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065+
                   FH_DM+FH_CVA+strata(FH_MI)+FH_CA)
...
# Model 4: Additionally Adjusted for Anthropometric Covariates
WAIST_Class <- factor(dff$WAIST_Class, levels=c(1,2))
cox_M4S2l <- coxph(Surv(entryage, exitage, DM_INC08)~lentil_rank+lentilsvg+lentilMedian+
                   SEX+
                   CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                   D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065+
                   FH_DM+FH_CVA+strata(FH_MI)+FH_CA+
...
cox_GS2P <- coxph(dff.surv~peas_rank+peasvg+PeasMedian)
summary(cox_GS2P)
...
cox_M1S2P <- coxph(Surv(entryage, exitage, DM_INC08)~peas_rank+peasvg+PeasMedian+
                   SEX)
summary(cox_M1S2P)
...
cox_M2S2P <- coxph(Surv(entryage, exitage, DM_INC08)~peas_rank+peasvg+PeasMedian+
                   SEX+
                   CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                   D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065)
summary(cox_M2S2P)
...
cox_M3S2P <- coxph(Surv(entryage, exitage, DM_INC08)~peas_rank+peasvg+PeasMedian+
                   SEX+
                   CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                   D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065+
                   FH_DM+FH_CVA+strata(FH_MI)+FH_CA)
...
# Model 4: Additionally Adjusted for Anthropometric Covariates
WAIST_Class <- factor(dff$WAIST_Class, levels=c(1,2))
cox_M4S2P <- coxph(Surv(entryage, exitage, DM_INC08)~peas_rank+peasvg+PeasMedian+
                   SEX+
                   CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                   D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065+
                   FH_DM+FH_CVA+strata(FH_MI)+FH_CA+
...
cox_GS2B <- coxph(dff.surv~beans_rank+beansvg+BeansMedian)
summary(cox_GS2B)
...
cox_M1S2B <- coxph(Surv(entryage, exitage, DM_INC08)~beans_rank+beansvg+BeansMedian+
                   SEX)
summary(cox_M1S2B)
...
cox_M2S2B <- coxph(Surv(entryage, exitage, DM_INC08)~beans_rank+beansvg+BeansMedian+
                   SEX+
                   CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                   D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065)
summary(cox_M2S2B)
...
cox_M3S2B <- coxph(Surv(entryage, exitage, DM_INC08)~beans_rank+beansvg+BeansMedian+
                   SEX+
                   CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                   D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065+
                   FH_DM+FH_CVA+strata(FH_MI)+FH_CA)
...
# Model 4: Additionally Adjusted for Anthropometric Covariates
WAIST_Class <- factor(dff$WAIST_Class, levels=c(1,2))
cox_M4S2B <- coxph(Surv(entryage, exitage, DM_INC08)~beans_rank+beansvg+BeansMedian+
                   SEX+
                   CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                   D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065+
                   FH_DM+FH_CVA+strata(FH_MI)+FH_CA+
...
cox_M5S3 <- coxph(Surv(entryage, exitage, DM_INC08)~S3legume_rankea+legumesvge+LCMedianS3+
                  SEX+
                  CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                  D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065+
                  FH_DM+FH_CVA+strata(FH_MI)+FH_CA+
...
# Adjusted Model with Covariates
cox_M5S4 <- coxph(Surv(entryage, exitage, DM_INC08)~S4legume_rank+legumesvge+LCMedianS4+
                    SEX+
                    CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                    D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065+
                    FH_DM+FH_CVA+strata(FH_MI)+FH_CA+
...
# Adjusted Model with Covariates
cox_M5S5 <- coxph(Surv(entryage, exitage, DM_INC08)~S5legume_rank+legumesvge+LCMedianS5+
                    SEX+
                    CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                    D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065+
                    FH_DM+FH_CVA+strata(FH_MI)+FH_CA+
...
# Adjusted Model with Covariates
cox_M5S6 <- coxph(Surv(entryage, exitage, DM_INC08)~S6legume_rank+legumesvge+LCMedianS6+
                    SEX+
                    CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                    D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065+
                    FH_DM+FH_CVA+strata(FH_MI)+FH_CA+
...
fit <- with(imputed, coxph(Surv(entryage, exitage, DM_INC08)~legume_rankr+legumesvg+LCMedianr+
                   SEX+
                   CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                   D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS++D1_NUT065+
                   FH_DM+FH_CVA+strata(FH_MI)+FH_CA+
...
#Univariate Model
#Tertile of Legume Consumer(1,2,3))
cox_GCTCP <- coxph(dff.surv~CPlegume_rank+legumesvg+LCMedianCTLP)
summary(cox_GCTCP)
...
cox_M1CTCP <- coxph(Surv(entryage, exitage, DM_INC08)~CPlegume_rank+legumesvg+LCMedianCTLP+
                  strata(SEX))
summary(cox_M1CTCP)
...
cox_M2CTCP <- coxph(Surv(entryage, exitage, DM_INC08)~CPlegume_rank+legumesvg+LCMedianCTLP+
                  strata(SEX)+
                  CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                  D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065)
summary(cox_M2CTCP)
...
cox_M3CTCP <- coxph(Surv(entryage, exitage, DM_INC08)~CPlegume_rank+legumesvg+LCMedianCTLP+
                  strata(SEX)+
                  CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                  D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065+
...
cox_M4CTCP <- coxph(Surv(entryage, exitage, DM_INC08)~CPlegume_rank+legumesvg+LCMedianCTLP+
                  strata(SEX)+
                  CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                  D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065+
                  FH_DM+FH_CVA+FH_MI+FH_CA+
...
#Univariate Model
#Tertile of Legume Consumer(1,2,3))
cox_GCTC <- coxph(dff.surv~Clegume_rank+legumesvg+LCMedianCTL)
summary(cox_GCTC)
...
cox_M1CTC <- coxph(Surv(entryage, exitage, DM_INC08)~Clegume_rank+legumesvg+LCMedianCTL+
                  strata(SEX))
summary(cox_M1CTC)
...
cox_M2CTC <- coxph(Surv(entryage, exitage, DM_INC08)~Clegume_rank+legumesvg+LCMedianCTL+
                  strata(SEX)+
                  CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                  D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065)
summary(cox_M2CTC)
...
cox_M3CTC <- coxph(Surv(entryage, exitage, DM_INC08)~Clegume_rank+legumesvg+LCMedianCTL+
                  strata(SEX)+
                  CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                  D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065+
                  FH_DM+FH_CVA+FH_MI+FH_CA)
...
cox_M4CTC <- coxph(Surv(entryage, exitage, DM_INC08)~Clegume_rank+legumesvg+LCMedianCTL+
                  strata(SEX)+
                  CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                  D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065+
                  FH_DM+FH_CVA+FH_MI+FH_CA+
