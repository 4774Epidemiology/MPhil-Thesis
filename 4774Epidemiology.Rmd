...
cox_GPE <- coxph(dff.surv~P_ranke+peanutsvg+PMediane)
summary(cox_GPE)
...
cox_M1PE <- coxph(Surv(entryage, exitage, DM_INC08)~P_ranke+peanutsvg+PMediane+
                   SEX)
summary(cox_M1PE)
...
cox_M2PE <- coxph(Surv(entryage, exitage, DM_INC08)~P_ranke+peanutsvg+PMediane+
                   SEX+
                   CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                   D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065)
summary(cox_M2PE)
...
cox_M3PE <- coxph(Surv(entryage, exitage, DM_INC08)~P_ranke+peanutsvg+PMediane+
                   SEX+
                   CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                   D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065+
                   FH_DM+FH_CVA+strata(FH_MI)+FH_CA)
...
# Model 4: Additionally Adjusted for Anthropometric Covariates
WAIST_Class <- factor(dff$WAIST_Class, levels=c(1,2))
cox_M4PE <- coxph(Surv(entryage, exitage, DM_INC08)~P_ranke+peanutsvg+PMediane+
                   SEX+
                   CIGSTAT+D1_NUT002+strata(RUPE)+SC+EDLEVEL09+
                   D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065+
                   FH_DM+FH_CVA+strata(FH_MI)+FH_CA+
...
```{r}
## Fit the model
mfit1 <- coxph(Surv(entryage, exitage, DM_INC08)~pspline(legumesvg, df=4)+legume_rankr+LCMedianr+
                  SEX+
...
mfit2<- coxph(Surv(entryage, exitage, DM_INC08)~pspline(lentilsvg, df=4)+lentil_rank+lentilMedian+
                   SEX+
                   CIGSTAT+D1_NUT002+strata(RUPE)+EDLEVEL09+
                   D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065+
                   FH_DM+FH_CVA+strata(FH_MI)+FH_CA+
...
matplot(lterm2$x, lterm2$HR, type='l', lty = 1, xlab = 'Consumption of lentils(servings/day)', 
        ylab='Hazard ratio', ylim=c(0,500))
...
mfit3 <- coxph(Surv(entryage, exitage, DM_INC08)~pspline(peasvg, df=4)+peas_rank+PeasMedian+
                   SEX+
                   CIGSTAT+D1_NUT002+strata(RUPE)+EDLEVEL09+
                   D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065+
                   FH_DM+FH_CVA+strata(FH_MI)+FH_CA+
...
```{r}
## Fit the model
mfit4 <- coxph(Surv(entryage, exitage, DM_INC08)~pspline(beansvg, df=4)+beans_rank+BeansMedian+
                   SEX+
                   CIGSTAT+D1_NUT002+strata(RUPE)+EDLEVEL09+
                   D1_VEG_A+D1_FRUIT_A+Fish+Meat+MILK+EGGS+D1_NUT065+
                   FH_DM+FH_CVA+strata(FH_MI)+FH_CA+
